...
namespace Pinetime {
  ...
  namespace Applications {
    namespace Screens {
      ...
      class WatchFaceGirliePopCasio : public Screen {
      public:
        WatchFaceGirliePopCasio(Controllers::DateTime& dateTimeController,
        ...
        ~WatchFaceGirliePopCasio() override;
      ...
      private:
        ...
        lv_color_t color_text = lv_color_hex(0xFF00FF);
    ...
    template <>
    struct WatchFaceTraits<WatchFace::GirliePopCasio> {
      static constexpr WatchFace watchFace = WatchFace::GirliePopCasio;
      static constexpr const char* name = "Girlie Pop Casio";

      static Screens::Screen* Create(AppControllers& controllers) {
        return new Screens::WatchFaceGirliePopCasio(controllers.dateTimeController,
      ...
      static bool IsAvailable(Pinetime::Controllers::FS& filesystem) {
        return Screens::WatchFaceGirliePopCasio::IsAvailable(filesystem);
      }
    };
  }
}
